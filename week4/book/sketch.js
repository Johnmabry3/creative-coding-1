...
function preload() {
  lines = loadStrings("https://johnmabry3.github.io/creative-coding-1/week4/book/Romeo%20and%20Juliet.txt");
}
...
function setup() {
  ...
  content.child(createElement("h1", mv.generate(2)));
  ...
  while (c < 8); // the number of chapters to generate.
